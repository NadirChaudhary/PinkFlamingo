  ...
  return (
    <div className="box">
      <div className="birdbox">
        <img src="/images/03.svg" alt="" className="bird" />
      ...
      <div className="box2">
        <div className="box3">
            <img src="/images/04.svg" alt="" className="location"/>
        ...
        <img src="/images/05.svg" alt="" className="searchIcon"/>
      </div>
      <div>
        <img src="/images/06.svg" alt="" className="cart" />
      </div>
      <div className="box5">
